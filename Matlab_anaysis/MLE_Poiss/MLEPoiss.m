function [VPoiss,CovMatPoiss,VPoissError]=MLEPoiss(rootparamsP,alpharoot,counts,tau)
%%%%%%%%%%
%%IN
%%-rootparamsP: Nbins values for the vexation at each bin for the naive model, 
