function [fmle,Vmle,CovMatmle,fmleError,VmleError]=MLE(root,alpharoot,counts,gauge,tau)
%%%%%%%%%%
%%IN
%%-root: a vector of size MaxPop+1 + Nbins (MaxPop+1 values for the frustration,the number of flies 
...
%%the linesearch algorithm that is implemented in the minimization,, must be positive, recomended is 0.001 
